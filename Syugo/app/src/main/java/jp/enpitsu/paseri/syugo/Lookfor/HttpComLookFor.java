...
public class HttpComLookFor extends AsyncTask<Integer, Integer, String> {
    ...
    private jp.enpitsu.paseri.syugo.Lookfor.HttpComLookFor.AsyncTaskCallback callback = null;
    HttpComLookFor(jp.enpitsu.paseri.syugo.Lookfor.HttpComLookFor.AsyncTaskCallback callback) {
