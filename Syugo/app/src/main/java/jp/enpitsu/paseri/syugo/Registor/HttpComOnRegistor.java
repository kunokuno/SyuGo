...
public class HttpComOnRegistor extends AsyncTask<Integer, Integer, LocationData>
{
    String myName, myID,mac_address;
    ...
    protected LocationData doInBackground(Integer... id) {
        ...
        StringBuilder uri = new StringBuilder(
                "http://ubermensch.noor.jp/enPiT/regist_user.php?" +
                        "name=" + myName + "&alt=30" + "&lat=29" + "&lan=99"
                        + "&accuracy=10" + "&etime=10"+ "&mac=" + mac_address);
    ...
    void setUserInfo( String user_name,String mac_address) {
